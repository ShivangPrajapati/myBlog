<?php
	...
	if(isset($_SESSION['loginemail']))
	{
		...
		if(isset($_POST['subject']))
		{
			...
			$query = "INSERT INTO contact_request (blogger_username, request_sub, request_msg, request_date) VALUES ('$email', '$subject', '$msg', '$date')";
	...
	<div class = "container">
    	...
    	<div class="collapse navbar-collapse" id="bs-myBlog-navbar-collapse-1">
          ...
          <ul class = "nav navbar-nav navbar-right">
            ...
            <li  class = "active"><a href = "contactus.php"><span class="glyphicon glyphicon-earphone"></span>  Contact</a></li>
...
<div class = "container">
  ...
  <div class = "col-md-6 col-md-push-4">
	  ...
	  <div class = "panel-body">
	    ...
	    <form role = "form" method = "post" action = "contactus.php" name = "contactForm" id = "contactForm" onSubmit = "return validatePassword()">
